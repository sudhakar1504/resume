...
import Banner from '../../assest/blue/experiance.gif'
import { toast, ToastContainer } from "react-toastify";
import 'react-toastify/dist/ReactToastify.css';
import { useHistory } from "react-router-dom";

const Experience = ({setExperiance}) => {
    ...
    const Gen=({countID})=>{
            ...
            return(
                ...
                <div className="c_name">
                    ...
                    <input type="text" id="c_name" name = {countID} autoComplete='off' placeholder="Eg abc solution pvt" defaultValue={structure?.[countID]?.name}/>
                </div>
                ...
                <div className="c_role">
                    ...
                    <input type="text" id="c_role" placeholder='Eg BackEnd Developer'autoComplete='off' defaultValue={structure?.[countID]?.role}/>
                </div>
                </div>
                ...
                <div className="S_date_and_E_date">
                    ...
                    <div className="present">
                        ...
                        <input type="checkbox" name="present" id="present" onClick={(e) =>checkHandle(e)} defaultChecked={structure?.[countID]?.present}/>
                    </div>
