...
import Banner from '../../assest/green/interest.gif';
import { toast, ToastContainer } from "react-toastify";
import 'react-toastify/dist/ReactToastify.css';
import { useHistory } from "react-router-dom";

const Interest = ({setIntesest}) => {
    ...
    const Gen=({countID})=>{
            ...
            return(
                ...
                <div className="c_name">
                    ...
                    <input type="text" id="c_name" name = {countID} autoComplete='off' placeholder="Eg cricket,dance,singing etc.." defaultValue={structure?.[countID]?.name}/>
                </div>
